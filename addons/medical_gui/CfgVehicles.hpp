        ...
        class ACE_Actions {
            ...
            class ACE_MainActions {
                ...
                class ACE_LoadPatient {
                    ...
                    condition = QUOTE(!(_target call EFUNC(common,isAwake)) && {alive _target} && {isNull objectParent _target} && {(_target call EFUNC(common,nearestVehiclesFreeSeat)) isNotEqualTo []});
